...
def main():
    ...
    columns_to_dummy = [
        ...
        '口縁部_新_主モチーフ',  # Updated feature
        '頸部', '頸部の傾向',
        '胴部', '胴部方向', '胴部_技法_縄文_特徴',
        '胴部_技法_磨消縄文_縄文', '胴部_技法_磨消縄文_施文順序', '胴部_技法_磨消縄文_図地', '胴部_器面調整',
        '胴部_新_主モチーフ',    # Updated feature
        '胴部_状態_連続・非連続', '胴部_状態_退化', '胴部_列数', '胴部_文様が開放', '胴部_変形',
        '胴部_主文様同士が並行/対向', '胴部_文様方向',
        '上端連繋', '下端連繋', '横位連繫線',
        '口縁部_技法_分類',      # Updated feature
        '胴部_技法_分類'         # Updated feature
    ]
    ...
    # ---------------------------------------------------------
    # 2. 複数選択項目の処理 (Multi-label processing)
    # ---------------------------------------------------------
